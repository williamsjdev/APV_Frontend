...
const Paciente = ({paciente}) => {
  ...
  return (
    <div className="mx-5 my-10 bg.withe shadow-md px-5 py-10 rounded-xl">
        ...
        <div className="flex justify-between my-5">
          <button
            type="button"
            className="py-2 px-10 bg-indigo-600 hover:bg-indigo-700 text-white upperxase 
            font-bold rounded"
            onClick={() => setEdicion(paciente)}
          >Editar</button>
          <button
            type="button"
            className="py-2 px-10 bg-red-600 hover:bg-indigo-700 text-white upperxase 
            font-bold rounded"
